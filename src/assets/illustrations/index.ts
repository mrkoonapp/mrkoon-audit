...
export { default as ProductBidsIllustration } from './product-bids-illustration';
...
export { default as ProductDurationIllustration } from './product-duration-illustration';

export { default as ProductInspectionsIllustration } from './product-inspections-illustration';
