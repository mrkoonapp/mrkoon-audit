...
export function ErrorBoundary() {
  ...
  // Handle stale chunk errors: after a new deployment, old chunk files no longer
  // exist. Reload once (throttled) so the browser fetches updated asset
  // references. If the failure persists, the reload is suppressed and the error
  // UI is shown instead of looping forever.
