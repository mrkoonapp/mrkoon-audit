...
export function NavUpgrade({ sx, ...other }: BoxProps) {
  ...
  const navigateToWebsite = () => {
    window.open(import.meta.env.VITE_MRKOON_WEBSITE);
  };

  return (
    <Box
      sx={[
        { px: 2, py: 5, textAlign: 'center', gap: 2, display: 'flex', flexDirection: 'column' },
    ...
    >
      <Stack
        ...
        sx={{
          ...
          p: 4,
          borderRadius: 4,
          boxShadow: ' 0 0 2px 0 rgba(0 0 0 / 0.5), 0 12px 24px -4px rgba(0 0 0 / 0.34)',
        }}
      >
